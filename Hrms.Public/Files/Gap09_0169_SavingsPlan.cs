...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0169_SavingsPlan : IGap09Common, IFixedLengthFile
    {
        ...
        /// <summary>Emp Retr System Plan</summary>
        [StartPosition(75), FieldFixedLength(4), FieldOrder(14)]
        public string EmployeeRetirementSystemPlan { get; set; }
