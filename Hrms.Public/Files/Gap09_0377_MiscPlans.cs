...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0377_MiscPlans : IGap09Common, IFixedLengthFile
    {
        public const string RecordTypeDefault = "0377";
        ...
        /// <summary>Option Miscellaneous Plan</summary>
        [StartPosition(79), FieldFixedLength(4), FieldOrder(15)]
        public string OptionMiscellaneousPlan { get; set; }

        /// <summary>Contribution Amount</summary>
        [StartPosition(83), FieldFixedLength(13), FieldOrder(16), FieldConverter(typeof(ImpliedDecimalConverter), Sign.TrailingSeparate, 10, 2)]
        public decimal ContributionAmount { get; set; }

        /// <summary>Contribution Percentage</summary>
        [StartPosition(96), FieldFixedLength(6), FieldOrder(17), FieldConverter(typeof(ImpliedDecimalConverter), Sign.TrailingSeparate, 3, 2)]
