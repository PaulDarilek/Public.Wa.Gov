...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0041_Dates : IGap09Common, IFixedLengthFile
    {
        ...
        /// <remarks>(Anniversary/ Seniority/ Appointment)</remarks>
        [StartPosition(69), FieldFixedLength(2), FieldOrder(12)]
        public string DateType { get; set; }

        /// <summary>Date for Date Type</summary>
        /// <remarks>(Anniversary/ Seniority/ Appointment date)</remarks>
