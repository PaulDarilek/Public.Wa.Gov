...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0008_BasicPay : IGap09Common, IFixedLengthFile
    {
        ...
        [StartPosition(71), FieldFixedLength(2), FieldOrder(13)]
        public string PayScaleType { get; set; }

        /// <summary>Pay Scale Area</summary>
        [StartPosition(73), FieldFixedLength(2), FieldOrder(14)]
        public string PayScaleArea { get; set; }

        /// <summary>Pay Scale Group</summary>
        [StartPosition(75), FieldFixedLength(8), FieldOrder(15)]
        public string PayScaleGroup { get; set; }

        /// <summary>Pay Scale Level</summary>
        [StartPosition(83), FieldFixedLength(2), FieldOrder(16)]
        public string PayScaleLevel { get; set; }

        /// <summary>Annual Salary</summary>
        /// <remarks>DEC 10.2 10 whole numbers plus 2 decimal positions (implied decimal point), zero filled from the left, rightmost position reserved for sign ('-' for negative amount, ' ' for positive amount)</remarks>
        [StartPosition(85), FieldFixedLength(13), FieldOrder(17), FieldConverter(typeof(ImpliedDecimalConverter), Sign.TrailingSeparate, 10, 2)]
        public decimal AnnualSalary { get; set; }

        /// <summary>Salary Component (Pay Code)</summary>
        /// <remarks>Array of 20 BasicPayAddition</remarks>
        [StartPosition(98), FieldOrder(18), FieldArrayLength(20), FieldFixedLength(Gap09_BasicPayAddition.Total_Length), FieldConverter(typeof(BasicPayAdditionConverter))]
        ...
        /// <remarks>YYYYMMDD PA0000 AEDTM Date of Last Change</remarks>
        [StartPosition(358), FieldFixedLength(8), FieldOrder(19), FieldConverter(typeof(DateWithZeroConverter))]
