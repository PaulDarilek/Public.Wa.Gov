...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0040_Loan : IGap09Common, IFixedLengthFile
    {
        ...
        /// <remarks>Object on Loan</remarks>
        ...
        /// <remarks>DEC(4,0) Number of Objects on Loan</remarks>
        [StartPosition(73), FieldFixedLength(5), FieldOrder(13), FieldConverter(typeof(ImpliedDecimalConverter), Sign.TrailingSeparate, 4, 0)]
        public decimal ObjectCount { get; set; }

        /// <summary>Measuring Unit</summary>
        [StartPosition(78), FieldFixedLength(3), FieldOrder(14), FieldTrim(TrimMode.Right)]
        public string MeasuringUnit { get; set; }

        /// <summary>Loan object number</summary>
        [StartPosition(81), FieldFixedLength(20), FieldOrder(15), FieldTrim(TrimMode.Right)]
