...
{
    /// <summary>Gap09 Record type 0022 (Education) - Multiple records permissible</summary>
    [FixedLengthRecord(FixedMode.ExactLength)]
    public class Gap09_0022_Education : IGap09Common, IFixedLengthFile
    {
        public const string RecordTypeDefault = "0022";
        public const int Total_Length = 160;
        ...
        /// <summary>Educational Establishment</summary>
        [StartPosition(69), FieldFixedLength(2), FieldOrder(12)]
        public string EducationCode { get; set; }

        /// <summary>Educational Establishment (number)</summary>
        /// <remarks>Education and Training NUMC(8)</remarks>
        [StartPosition(71), FieldFixedLength(8), FieldOrder(13)]
        public string EducationTraining { get; set; }

        /// <summary>Institute/location of training</summary>
        /// <remarks>Institute/location</remarks>
        [StartPosition(79), FieldFixedLength(80), FieldOrder(14), FieldTrim(TrimMode.Right)]
        public string Institute { get; set; }

        /// <summary>Professional License</summary>
        [StartPosition(159), FieldFixedLength(2), FieldOrder(15), FieldTrim(TrimMode.Right)]
