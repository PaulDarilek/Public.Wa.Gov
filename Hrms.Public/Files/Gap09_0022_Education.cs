...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0022_Education : IGap09Common, IFixedLengthFile
    {
        ...
        [FieldOrder(12)]
        [FieldFixedLength(2)]
        [StartPosition(69, "Educational Establishment")]
        public string EducationCode { get; set; }

        /// <summary>Educational Establishment (number)</summary>
        [FieldOrder(13)]
        [FieldFixedLength(8)]
        [StartPosition(71, "Education and Training NUMC(8)")]
        ...
        [FieldFixedLength(80)]
        [FieldTrim(TrimMode.Right)]
        [StartPosition(79, "Institute/location")]
        ...
        [FieldFixedLength(2)]
        [FieldTrim(TrimMode.Right)]
        [StartPosition(159, "Professional License")]
