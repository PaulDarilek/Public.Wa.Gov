...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0167_HealthPlans : IGap09Common, IFixedLengthFile
    {
        ...
        /// <summary>Benefit Area</summary>
        [StartPosition(69), FieldFixedLength(2), FieldOrder(12)]
        public string BenefitArea { get; set; }

        /// <summary>Plan Type</summary>
        [StartPosition(71), FieldFixedLength(4), FieldOrder(13)]
        public string PlanType { get; set; }

        /// <summary>Benefit Plan</summary>
        [StartPosition(75), FieldFixedLength(4), FieldOrder(14)]
        public string BenefitPlan { get; set; }

        /// <summary>Health Plan Option</summary>
        [StartPosition(79), FieldFixedLength(4), FieldOrder(15)]
        public string HealthPlanOption { get; set; }

        /// <summary>Dependent Coverage</summary>
        [StartPosition(83), FieldFixedLength(4), FieldOrder(16)]
        public string DependentCoverage { get; set; }

        /// <summary>Calculation Period</summary>
        [StartPosition(87), FieldFixedLength(2), FieldOrder(17)]
        public string CalculationPeriod { get; set; }

        /// <summary>Calculation Date</summary>
        [StartPosition(89), FieldFixedLength(8), FieldOrder(18), FieldConverter(ConverterKind.Date, "yyyyMMdd")]
        public DateTime CalculationDate { get; set; }

        /// <summary>Calculation Date</summary>
        [StartPosition(97), FieldFixedLength(13), FieldOrder(19), FieldConverter(typeof(ImpliedDecimalConverter), Sign.TrailingSeparate, 10, 2)]
        public decimal EmployeeCost { get; set; }

        /// <summary>Calculation Date</summary>
        [StartPosition(110), FieldFixedLength(13), FieldOrder(20), FieldConverter(typeof(ImpliedDecimalConverter), Sign.TrailingSeparate, 10, 2)]
