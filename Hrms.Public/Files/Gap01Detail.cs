...
namespace Hrms.Public.Files
{
    ...
    public class Gap01Detail : IFixedLengthFile
    {
        ...
        [FieldFixedLength(4)]
        [FieldSpec(4, 3, "Enterprise Structure Personnel area Agency/subagency equivalent")]
        ...
        [FieldFixedLength(8)]
        [FieldSpec(8, 7, "Employee number/Personnel number")]
        public string EmployeeNumber;

        /// <summary>CHAR(9) 9 15 CATS/ 0554 Can send this or Employee number PA0002 PERID SSN</summary>
        [FieldFixedLength(9)]
        [FieldSpec(9, 15, "Can send this or Employee number")]
        public string SSN;
        ...
        [FieldSpec(5, 48, "DEC(3,2) 3 whole numbers plus 2 decimal positions (implied decimal point), zero filled from the left, NO NEGATIVE NUMBERS ALLOWED.")]
        ...
        /// </summary>
        [FieldFixedLength(11)]
        [FieldSpec(11, 101, "If any labor cost distribution fields are filled, all must be filled. If a field is not used by agency, fill with AFRS agency code followed by all zeros. (AFRS Agency + Project + Sub-Project) a. Chars 1-3 Three char AFRS Agency code b. Chars 4-11 Eight char AFRS Project structure")]
        ...
        /// </summary>
        [FieldFixedLength(7)]
        [FieldSpec(7, 112, "NUMC(7) 7 112 CATS If any labor cost distribution fields are filled, all must be filled. If a field is not used by agency, fill with AFRS agency code followed by all zeros.(AFRS Agency + Allocation Code) a. Chars 1-3 Three char AFRS Agency code b. Chars 4-7 Four char AFRS Allocation code")]
        ...
        [FieldFixedLength(8)]
        [FieldSpec(8, 119, "This is the SAP position number for CATS and/or for IT0554")]
        public string PositionNumber;

        /// <summary>CHAR(08) 8 127 CATS This is used for Pay Scale Information along with Position on IT2010</summary>
        [FieldFixedLength(8)]
        [FieldSpec(8, 127, "This is used for Pay Scale Information along with Position on IT2010")]
        ...
        [FieldFixedLength(2)]
        [FieldSpec(2, 135, "This is used for Pay Scale Information along with Position on IT2010")]
        ...
        [FieldSpec(7, 140, "DEC(5,2) 5 whole numbers plus 2 decimal positions (implied decimal point), zero filled from the left, NO NEGATIVE NUMBERS ALLOWED.")]
