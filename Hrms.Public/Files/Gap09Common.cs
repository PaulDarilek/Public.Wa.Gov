...
{
    public abstract class Gap09Common : IFixedLengthFile
    {
        ...
        public char EmployeeGroup { get; set; }
        ...
        [FieldSpec(8, 24, "YYYYMMDD PA0000 AEDTM Date of Last Change")]
        ...
        public abstract bool IsPossibleRecord(string record);
    }
}