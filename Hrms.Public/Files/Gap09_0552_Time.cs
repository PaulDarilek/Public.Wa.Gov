...
{
    /// <summary>Gap09 Record type 0552 (Time Specifications / Employment Period)</summary>
    [FixedLengthRecord(FixedMode.ExactLength)]
    public class Gap09_0552_Time : IGap09Common, IFixedLengthFile
    {
        public const string RecordTypeDefault = "0552";
        public const int Total_Length = 84;
        ...
        /// <summary>Time Specifications</summary>
        [StartPosition(69), FieldFixedLength(4), FieldOrder(12)]
        public string TimeSpecifications { get; set; }

        /// <summary>Imputable Period, Years</summary>
        [StartPosition(73), FieldFixedLength(3), FieldOrder(13), FieldConverter(typeof(IntConverter), 3, false)]
        public int ImputablePeriodYears { get; set; }

        /// <summary>Imputable Period, Months</summary>
        [StartPosition(76), FieldFixedLength(4), FieldOrder(14), FieldConverter(typeof(IntConverter), 4, false)]
        public int ImputablePeriodMonths { get; set; }

        /// <summary>Imputable Period, Days</summary>
        [StartPosition(80), FieldFixedLength(5), FieldOrder(15), FieldConverter(typeof(IntConverter), 5, false)]
        public int ImputablePeriodDays { get; set; }
