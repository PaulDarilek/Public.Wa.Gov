...
namespace Hrms.Public.Files
{
    ...
    public class Gap09_0023_Employers : IGap09Common, IFixedLengthFile
    {
        ...
        [StartPosition(69), FieldFixedLength(20), FieldOrder(12), FieldTrim(TrimMode.Right)]
        public string EmployerName { get; set; }

        /// <summary>City</summary>
        [StartPosition(89), FieldFixedLength(25), FieldOrder(13), FieldTrim(TrimMode.Right)]
        public string City { get; set; }

        /// <summary>Job at former employers</summary>
        /// <remarks>NUMC(8)</remarks>
        [StartPosition(114), FieldFixedLength(8), FieldOrder(14), FieldTrim(TrimMode.Right)]
        public string Job { get; set; }

        /// <summary>Undefined 40 spaces that seem to be on downloaded file</summary>
        /// <remarks>Do not use</remarks>
        [StartPosition(122), FieldFixedLength(40), FieldOrder(99), FieldTrim(TrimMode.Right), FieldOptional]
